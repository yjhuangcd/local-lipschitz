...
python train_mnist.py --model relux --sniter 5 --init 2.0 --epsilon_train 1.75 --gloro --no_augmentation --opt_iter 10
...
python train_cifar10.py --model c6f2_relux --sniter 2 --init 2.0 --end_lr 1e-6 
...
python train_cifar10.py --model c6f2_clmaxmin --sniter 2 --end_lr 1e-6
